...
<body class="animated fadeIn">
	...
	<div class="min-h-screen md:flex">
		...
		<div class="flex content-start flex-wrap mx-5 mt-1">
			<div style="background-image: url({{ asset('img/batman.jpg') }});" class="design cursor-default bg-white my-5 mx-3 hover:border-grey border-2 relative rounded shadow">
			...
			<div class="test2 bg-white my-5 mx-3 hover:border-grey border-2 relative rounded shadow">
